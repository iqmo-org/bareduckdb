...
class TestNaNFilterPushdown:
    ...
    def test_nan_equal_float32(self, float_table_with_nan, unique_table_name, conn):
    ...
    def test_nan_equal_float64(self, double_table_with_nan, unique_table_name, conn):
    ...
    def test_nan_not_equal_float(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_greater_than_float(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_greater_equal_float(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_less_than_float(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_less_equal_float(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_with_and_clause(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_negative_nan_equal_positive_nan(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_ordering_in_order_by(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_count_with_filter(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_nan_equal_without_pushdown(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_explain_shows_filter_pushdown(self, float_table_with_nan, unique_table_name, conn):
        conn.register(unique_table_name, float_table_with_nan)
    ...
    def test_explain_without_pushdown_shows_separate_filter(self, float_table_with_nan, conn):
